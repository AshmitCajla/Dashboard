...
#     """Render individual farm visualization section"""
...
#     """Render group visualization section with farm selection"""
...
def render_group_visualization(groups, farm_daily_avg, farm_weekly_avg):
    ...
    fig1.add_trace(go.Scatter(
        ...
        mode='lines+markers',
        name="Group Average",
        line=dict(width=3, dash='solid', color='black'),
