...
#     st.markdown("Analysis of Kharif 25 farm data with water level measurements")
...
#             st.subheader("Farm Groups Created")
#             for group_name, group_df in farm_groups.items():
#                 st.write(f"**{group_name}**: {len(group_df)} farms")
